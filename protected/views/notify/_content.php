...
$tpye_name = array('1' => 'เตือนครบกำหนดค้ำประกันสัญญา','2' => 'เตือนครบกำหนดชำระเงินของลูกค้า','3' => 'เตือนครบกำหนดจ่ายเงินให้ผู้รับจ้าง/ผู้ขาย','4' => 'เตือนบันทึกค่าบริหารงานโครงการ','5' => 'เตือนปิดโครงการ' ,'6' => 'เตือนของบ .1000');
foreach ($records as $key => $value) {
