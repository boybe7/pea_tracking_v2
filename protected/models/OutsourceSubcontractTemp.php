...
/**
 * This is the model class for table "outsource_subcontract_temp".
 *
 * The followings are the available columns in table 'outsource_subcontract_temp':
 ...
 */
class OutsourceSubcontractTemp extends CActiveRecord
{
	/**
	...
	{
		return 'outsource_subcontract_temp';
	}
	...
	public function rules()
	{
		...
		return array(
			array('oc_id, oc_code, oc_PO, oc_proj_id, oc_vendor_id, oc_sign_date, oc_end_date, oc_approve_date, oc_cost, oc_T_percent, oc_A_percent, oc_guarantee, oc_insurance_start, oc_insurance_end, oc_user_create, oc_user_update, u_id', 'required'),
			array('oc_id, oc_proj_id, oc_vendor_id, oc_T_percent, oc_A_percent, oc_user_create, oc_user_update, u_id', 'numerical', 'integerOnly'=>true),
			...
			array('osc_id, oc_id, oc_code, oc_PO, oc_proj_id, oc_vendor_id, oc_detail, oc_sign_date, oc_end_date, oc_approve_date, oc_cost, oc_T_percent, oc_A_percent, oc_guarantee, oc_guarantee_cf, oc_adv_guarantee, oc_adv_guarantee_cf, oc_insurance, oc_insurance_start, oc_insurance_end, oc_letter, oc_user_create, oc_user_update, u_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function searchByUser($cid,$uid) {
		...
		$criteria->condition = "oc_id='$cid' AND u_id='$uid'";
	 ...
	 * @return OutsourceSubcontractTemp the static model class
	 */
