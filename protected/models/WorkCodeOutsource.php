...
/**
 * This is the model class for table "work_code_outsource".
 *
 * The followings are the available columns in table 'work_code_outsource':
 * @property integer $id
 * @property string $PO
 ...
 */
class WorkCodeOutsource extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, PO, contract_id, letter, money', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return WorkCodeOutsource the static model class
	 */
