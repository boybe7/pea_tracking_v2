 ...
 */
class GuaranteeTemp extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('guarantee_no, contract_no,pj_id,cost, guarantee_date', 'required'),
			array('contract_no,pj_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, guarantee_no, contract_no,pj_id, letter_confirm, cost, guarantee_date, letter_return', 'safe', 'on'=>'search'),
		);
	}
	...
	public function searchByUser($cid,$pid) {

		$criteria=new CDbCriteria;
		$criteria->select = '*';
		$criteria->condition = "contract_no='$cid' AND pj_id='$pid'";
